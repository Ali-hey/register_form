...
const validationSchema = Yup.object({
  ...
  mobile: Yup.number().when("auth_mode", {
    is: "mobile",
    then: Yup.number().required("شماره موبایل اجباری"),
  }),
  ...
  date: Yup.string().required("تاریخ تولد اجباری"),
  image: Yup.mixed()
    .required("لطفا این قسمت را وارد کنید")
    .test(
      "fileSize",
      "حجم فایل باید کمتر از 100 کیلو بایت باشد",
          ...
          {(formik) => {
            ...
            return (
              <div className="wrap-login100">
                <Form
                  className="login100-form validate-form pos-relative
